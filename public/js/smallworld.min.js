(function (root, factory) {
  ...
  Smallworld.prototype = {
    ...
    initialize: function () {
      ...
      // Ugly fix for when the map is in display none
      if (this.el.clientWidth != 0) {
      	this.width = this.el.clientWidth;
      } else {
      	this.width = parseInt(window.getComputedStyle(el).getPropertyValue('min-width'));
      }

      if (this.el.clientHeight != 0) {
      	this.height = this.el.clientHeight;
      } else {
      	this.height = parseInt(window.getComputedStyle(el).getPropertyValue('min-height'));
      }
